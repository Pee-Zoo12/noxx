        ...
        <div class="header-content">
            ...
            <div class="logo">
                <a href="<?php echo SITE_URL; ?>" class="logo-link">
                    <img src="<?php echo SITE_URL; ?>/assets/images/noxlogo.png" alt="<?php echo htmlspecialchars($company->getName() ?? 'NOX Clothing'); ?>" class="logo-image">
                </a>
            </div>
            ...
            <div class="header-actions">
                <?php if ($isLoggedIn): ?>
                    ...
                    <div class="user-menu">
                        <button type="button" class="user-menu-toggle" aria-label="Toggle user menu" aria-expanded="false" aria-controls="userDropdown">
                        ...
                        <div class="user-dropdown" id="userDropdown" role="menu">
                            <div class="user-info">
                                ...
                                <div class="user-details">
                                    ...
                                    <div class="user-email"><?php echo isset($user) ? htmlspecialchars($user->getEmail()) : ''; ?></div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="<?php echo SITE_URL; ?>/logout.php" class="dropdown-item text-danger" role="menuitem">
...
<?php if (function_exists('displayFlashMessage')) echo displayFlashMessage(); ?>
